...
export const updateArticle = async (id: string, formData: FormData) => axiosInstance.patch(`/api/admin/articles/${id}`, formData, { headers: { 'Content-Type': 'multipart/form-data' } });
