          ...
          <div className="flex items-center justify-between mb-8 pb-6 border-b border-slate-100">
            ...
            {!isEditing ? (
              <button 
                ...
                className="flex items-center gap-2 text-sm font-bold text-sky-600 bg-sky-50 px-4 py-2 rounded-full hover:bg-sky-100 transition-colors"
              >
              ...
              <div className="flex items-center gap-2">
                ...
                <button 
                  ...
                  disabled={isSaving}
                  className="flex items-center gap-2 text-sm font-bold text-white bg-sky-600 px-4 py-2 rounded-full hover:bg-sky-700 transition-colors disabled:opacity-50"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  disabled={!isEditing}
                  className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none transition-all disabled:opacity-70 disabled:cursor-not-allowed"
                />
              </div>
              <div>
