        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div>
            <h1 className="text-3xl font-black text-slate-900 flex items-center gap-3">
              <Package className="w-8 h-8 text-sky-500" /> My Orders
            </h1>
          ...
          <form onSubmit={handleSearch} className="relative">
            <input
              ...
              className="pl-10 pr-4 py-2.5 bg-white border border-slate-200 rounded-full text-sm font-medium focus:outline-none focus:ring-2 focus:ring-sky-500 w-full sm:w-64 shadow-sm"
            />
            <button type="submit" className="absolute left-3 top-2.5">
              <Search className="w-4 h-4 text-slate-400 hover:text-sky-500 transition-colors" />
            </button>
          </form>
        </div>
