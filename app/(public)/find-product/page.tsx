...
import { ChevronRight, ChevronLeft, Search, Package, Star, MapPin, ArrowRight, Settings } from 'lucide-react';
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-black text-slate-900 tracking-tight mb-4">
            Find Your <span className="text-sky-500">Perfect Fit</span>
          </h1>
          <p className="text-slate-500 max-w-2xl mx-auto text-lg">
            Follow our guided search to instantly discover the exact products engineered for your specific requirements.
          </p>
        </div>
            ...
            >
              {isLoading ? (
                ...
                <div className="col-span-full text-center py-12 text-slate-500">
                  No guided search blueprints available at the moment.
                </div>
              )}
            </motion.div>
          )}
                ...
                <div className="py-6">
                  ...
                  {isOptionsLoading ? (
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                      {currentOptions.map((option, idx) => (
                        <button
                          ...
                          className="px-6 py-4 text-left border border-slate-200 rounded-xl hover:border-sky-500 hover:bg-sky-50 focus:ring-2 focus:ring-sky-500 focus:outline-none transition-all font-medium text-slate-700 hover:text-sky-700"
                        >
                          {option}
                        </button>
                      ))}
                    ...
                    <div className="text-center py-12 bg-slate-50 rounded-2xl border border-slate-100">
                      <p className="text-slate-500">No options found for this selection.</p>
                      <button 
                        onClick={goBack}
              ...
              {isSearching ? (
                  ...
                  {results.map((product) => (
                    ...
                    >
                      <div className="relative aspect-square bg-slate-100 p-6 overflow-hidden">
                        ...
                        <div className="absolute top-4 right-4 bg-white/90 backdrop-blur px-2.5 py-1 rounded-full text-xs font-bold text-slate-700 shadow-sm">
                          {product.sku}
                        </div>
                      </div>
                ...
                <div className="text-center py-24 bg-white rounded-3xl border border-slate-200">
                  ...
                  <p className="text-slate-500 max-w-md mx-auto mb-8">
                    We couldn't find any products matching your exact specifications. Try adjusting your search criteria.
                  </p>
                  <button 
                    onClick={goBack}
