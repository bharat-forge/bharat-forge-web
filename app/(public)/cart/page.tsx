      ...
      <div className="max-w-7xl mx-auto">
        ...
        {items.length === 0 ? (
          <div className="bg-white rounded-3xl border border-slate-200 p-16 text-center shadow-sm">
            ...
            <Link 
              href="/shop"
              className="inline-flex items-center gap-2 bg-sky-500 text-white px-8 py-3 rounded-full font-medium hover:bg-sky-600 transition-colors"
            >
                  ...
                  <div className="flex flex-col items-center sm:items-end gap-4 border-t sm:border-t-0 sm:border-l border-slate-100 pt-4 sm:pt-0 sm:pl-6">
                    ...
                    <div className="flex items-center gap-3 bg-slate-50 border border-slate-200 rounded-full px-2 py-1">
                      <button 
                        ...
                        className="w-8 h-8 flex items-center justify-center text-slate-400 hover:text-sky-500 hover:bg-white rounded-full transition-colors"
                      >
            ...
            <div className="lg:col-span-4">
              <div className="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm sticky top-28">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex items-center justify-between text-slate-600">
                    <span>Shipping</span>
                    <span className="font-semibold text-sky-600">Calculated at checkout</span>
                  </div>
                </div>
