            ...
            >
                ...
                <form id="articleForm" onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-sky-500 outline-none resize-none font-mono text-sm leading-relaxed"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <select 
                        ...
                        className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-sky-500 outline-none min-h-[120px]"
                      >
                        {categories.map(cat => (
              ...
              <div className="p-6 border-t border-slate-100 bg-slate-50/50 flex gap-3 flex-shrink-0">
                ...
                <button 
                  ...
                  className="flex-1 py-3 bg-sky-500 text-white rounded-xl font-bold hover:bg-sky-600 transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
                >
