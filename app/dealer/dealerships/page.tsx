                      ...
                      {req.status === 'PENDING' ? (
                        ...
                        <div className="flex items-center justify-end gap-3">
                          ...
                          <Link 
                            ...
                            className="inline-flex items-center gap-2 px-3 py-1.5 bg-sky-50 hover:bg-sky-100 text-sky-600 rounded-lg text-xs font-bold transition-colors border border-sky-100 hover:border-sky-200"
                          >
