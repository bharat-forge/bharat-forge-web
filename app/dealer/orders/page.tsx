      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 rounded-3xl border border-slate-200 shadow-sm">
        ...
        <form onSubmit={handleSearch} className="relative w-full sm:w-auto">
          <input
            ...
            className="w-full sm:w-64 pl-12 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-sky-500 focus:bg-white outline-none transition-all font-medium text-slate-700"
          />
          <button type="submit" className="absolute left-4 top-3">
            <Search className="w-5 h-5 text-slate-400 hover:text-sky-500 transition-colors" />
          </button>
        </form>
      </div>
      ...
      {orders.length === 0 && !isLoading ? (
        ...
        <div className="space-y-4">
          {orders.map((order) => {
            ...
            return (
              <div key={order.id} className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden transition-all hover:border-sky-200">
                <div 
                ...
                >
                  ...
                  <div className="flex items-center justify-end">
                    <div className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 hover:text-sky-600 transition-colors">
