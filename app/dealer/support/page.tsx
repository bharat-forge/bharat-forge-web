      ...
      <div className="flex-shrink-0 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 rounded-3xl border border-slate-200 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-500 text-sm mt-1">Get dedicated assistance from the Bharat Forge team</p>
          </div>
        </div>
        <button 
                    ...
                    return (
                      <div key={idx} className={`flex ${isMe ? 'justify-end' : 'justify-start'}`}>
                        <div className={`flex items-end gap-2 max-w-[85%] ${isMe ? 'flex-row-reverse' : 'flex-row'}`}>
                          ...
                          <div className={`p-4 rounded-2xl text-sm shadow-sm flex flex-col ${
                            isMe 
                ...
                <div className="flex-shrink-0 p-4 bg-white border-t border-slate-100 z-10">
                  <form onSubmit={handleSendMessage} className="flex gap-3 bg-slate-50 p-2 rounded-full border border-slate-200 focus-within:ring-2 focus-within:ring-sky-500/20 focus-within:bg-white transition-all">
                    ...
                    <button 
                      ...
                      className="w-10 h-10 bg-sky-500 text-white rounded-full flex items-center justify-center hover:bg-sky-600 disabled:opacity-50 transition-all shadow-md flex-shrink-0 shadow-sky-500/20"
                    >
            ...
            >
              ...
              <form onSubmit={handleCreateTicket} className="p-6 space-y-5">
                ...
                <div className="pt-4 flex gap-3">
                  ...
                  <button type="submit" className="flex-1 py-3 bg-sky-500 text-white rounded-xl font-bold hover:bg-sky-600 transition-colors">
                    Submit Ticket
                  </button>
                </div>
              </form>
