              ...
              <motion.form key="credentials" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0, x: -20 }} className="space-y-5" onSubmit={handleLogin}>
                ...
                <div className="flex items-center justify-between mt-2">
                  <div className="text-sm">
                    <a href="#" className="font-medium text-sky-600 hover:text-sky-500 transition-colors">Forgot your password?</a>
                  </div>
                </div>
              ...
              <motion.form key="otp" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-6" onSubmit={handleVerifyOTP}>
                <div className="text-center">
                  ...
                  <input
                    ...
                    className="block w-full px-4 py-4 border border-slate-200 rounded-xl bg-slate-50 focus:bg-white focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 text-center tracking-[0.75em] font-bold text-2xl text-slate-900 outline-none transition-colors"
                    placeholder="------"
                  />
                </div>
                ...
                <div className="flex flex-col items-center justify-center pt-2 space-y-3">
                  {countdown > 0 ? (
                    ...
                    <button type="button" onClick={handleResendOTP} disabled={resendLoading} className="text-sm font-medium text-sky-600 hover:text-sky-700 flex items-center gap-2 transition-colors">
