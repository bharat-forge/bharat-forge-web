...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-slate-900 border-t border-sky-500/30">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full flex flex-col items-center justify-center pointer-events-none z-0 select-none overflow-hidden opacity-10">
        <motion.span
          ...
          className="text-[18vw] font-black leading-[0.8] tracking-tighter whitespace-nowrap bg-clip-text text-transparent bg-[length:200%_auto] dot-mask bg-gradient-to-r from-slate-900 via-sky-500 to-slate-900"
        >
          BHARAT
        </motion.span>
        <motion.span
          animate={{ backgroundPosition: ["-200% center", "200% center"] }}
          transition={{ repeat: Infinity, repeatType: "reverse", ease: "easeInOut", duration: 12 }}
          className="text-[18vw] font-black leading-[0.8] tracking-tighter whitespace-nowrap ml-[20vw] bg-clip-text text-transparent bg-[length:200%_auto] dot-mask bg-gradient-to-r from-slate-900 via-sky-500 to-slate-900"
        >
          FORGE
        </motion.span>
      </div>
      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-12 lg:py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            <p className="text-base text-slate-300 leading-relaxed max-w-sm mb-8 font-medium">
              Premium Importers & Distributors. Connecting global industries to the finest forged components.
            </p>

            <div className="flex gap-4">
              <Link href="#" className="p-2.5 rounded-full bg-white/5 text-slate-300 hover:bg-sky-500 hover:text-white transition-all border border-white/10 hover:scale-110">
                <Linkedin size={20} />
              </Link>
              <Link href="#" className="p-2.5 rounded-full bg-white/5 text-slate-300 hover:bg-sky-500 hover:text-white transition-all border border-white/10 hover:scale-110">
                <Twitter size={20} />
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="text-slate-300 font-medium space-y-5">
              <li className="flex items-start gap-3 text-sm group">
                <div className="p-2 bg-white/5 border border-white/10 rounded-lg group-hover:bg-sky-500/20 group-hover:border-sky-500/50 transition-colors">
                  <MapPin size={16} className="text-sky-500" />
                </div>
                <span className="mt-1 leading-relaxed">Bharat Forge Headquarters,<br/>Pune, India</span>
              </li>
              <li className="flex items-center gap-3 text-sm group">
                <div className="p-2 bg-white/5 border border-white/10 rounded-lg group-hover:bg-sky-500/20 group-hover:border-sky-500/50 transition-colors">
                  <Phone size={16} className="text-sky-500" />
                </div>
                <span className="leading-relaxed">+91 20 2682 4666</span>
              </li>
              <li className="flex items-start gap-3 text-sm group">
                <div className="p-2 bg-white/5 border border-white/10 rounded-lg group-hover:bg-sky-500/20 group-hover:border-sky-500/50 transition-colors">
                ...
                <div className="flex flex-col mt-1">
                  <span>info@bharatforge.com</span>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <span className="text-sm font-medium text-slate-400">
            © {new Date().getFullYear()} Bharat Forge Limited. All rights reserved.
          </span>

          <div className="flex gap-3 text-xs font-bold text-slate-300 uppercase tracking-widest">
            <span className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-md">ISO 9001 Certified</span>
            <span className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-md">Global Distributor</span>
          </div>
        </div>
      </div>
    </footer>
