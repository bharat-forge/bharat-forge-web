      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link href="/shop" className="text-sm font-medium text-slate-700 hover:text-sky-500 transition-colors">
              Products
            </Link>
            <Link href="/find-product" className="text-sm font-medium text-slate-700 hover:text-sky-500 transition-colors">
              Find Your Product
            </Link>
            <Link href="/dealer-locator" className="text-sm font-medium text-slate-700 hover:text-sky-500 transition-colors">
              Dealer Locator
            </Link>
            <Link href="/blogs" className="text-sm font-medium text-slate-700 hover:text-sky-500 transition-colors">
              Blogs
            </Link>
